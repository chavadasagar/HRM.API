...
namespace Migrators.MSSQL.Migrations.Application
{
    ...
    [Migration("20220524045147_migrations_24052022_2")]
    partial class migrations_24052022_2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRM.API.Domain.Catalog.Unit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.ProductQuantiy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.Purchase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.PurchasePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.PurchaseProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.PurchaseReturn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.PurchaseReturnPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.PurchaseReturnProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Catalog.Product", b =>
                {
                    ...
                    b.HasOne("HRM.API.Domain.Catalog.Unit", "Unit")
                        .WithMany()
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.Purchase", b =>
                {
                    ...
                    b.HasOne("HRM.API.Domain.Catalog.Supplier", "Supplier")
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.PurchasePayment", b =>
                {
                    b.HasOne("HRM.API.Domain.Catalog.PaymentType", "PaymentType")
                        .WithMany()
                        .HasForeignKey("PaymentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRM.API.Domain.Inventory.Purchase", "Purchase")
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.PurchaseProduct", b =>
                {
                    b.HasOne("HRM.API.Domain.Catalog.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.PurchaseReturnPayment", b =>
                {
                    ...
                    b.HasOne("HRM.API.Domain.Inventory.PurchaseReturn", "Purchase")
            ...
            modelBuilder.Entity("HRM.API.Domain.Inventory.PurchaseReturnProduct", b =>
                {
                    ...
                    b.HasOne("HRM.API.Domain.Inventory.PurchaseReturn", "PurchaseReturn")
