...
namespace Migrators.MSSQL.Migrations
{
    ...
    [Migration("20240120094101_add_tiket_and_estimate_module")]
    partial class add_tiket_and_estimate_module
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRM.API.Domain.Catalog.Estimates.Estimate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Catalog.Estimates.EstimateItems", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Catalog.Tax", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRM.API.Domain.Catalog.Estimates.Estimate", b =>
                {
                    ...
                    b.HasOne("HRM.API.Domain.Catalog.Tax", "Tax")
                        .WithMany()
                        .HasForeignKey("TaxId");
            ...
            modelBuilder.Entity("HRM.API.Domain.Catalog.Estimates.EstimateItems", b =>
                {
                    b.HasOne("HRM.API.Domain.Catalog.Designation", "Amount")
                        .WithMany()
                        .HasForeignKey("AmountId");

                    b.HasOne("HRM.API.Domain.Catalog.Estimates.Estimate", "Estimate")
