...
public class PurchaseReturnProduct : AuditableEntity, IAggregateRoot
{
    ...
    public virtual PurchaseReturn PurchaseReturn { get; private set; } = default!;
    public virtual Product Product { get; private set; } = default!;

    public PurchaseReturnProduct(Guid purchaseReturnId, Guid productId, string? productName, decimal quantity, decimal purchasePrice, decimal? discount, short? discountType, decimal? totalDiscount, decimal cGST, decimal sGST, short taxType, decimal totalTax, decimal unitCostAfterTaxAndDiscount, decimal totalAmount)
    {
    ...
    public PurchaseReturnProduct Update(Guid? productId, string? productName, decimal? quantity, decimal? purchasePrice, decimal? discount, short? discountType, decimal? totalDiscount, decimal? cGST, decimal? sGST, short? taxType, decimal? totalTax, decimal? unitCostAfterTaxAndDiscount, decimal? totalAmount)
    {
